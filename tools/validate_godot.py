...
headless = (root / 'tests' / 'headless_runner.gd').read_text(encoding='utf-8')
for token in ('extends SceneTree', 'HEADLESS PASS', 'save restore', 'diplomacy actions', 'space station mission', 'ResourceLoader.exists'):
